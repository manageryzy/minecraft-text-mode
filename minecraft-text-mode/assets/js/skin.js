...
var pngURL = window.location.search
if (pngURL === '' || pngURL === '?') pngURL = 'steve.png'
else pngURL = 'skin.php?username='+pngURL.substr(1, pngURL.length - 1)
...
var render = function () {
  ...
  camera.position.y = (100/(ch/2))*1.5+0.2;
